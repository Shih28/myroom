...
We've complete a demo using flutter and local sql database, and now moving to flutter + firebase for a semi-production release. Your goal is the refactor this project. The guides are in refactor_guide folder, read Overview.md and Phase.md first. The summary of current implementation is at Project.md.
