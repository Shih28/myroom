...
class _TutorialOverlayState extends State<TutorialOverlay>
  ...
  static const _pages = [
    _TutorialPage(
      ...
      description: 'Your personal space to capture everything that matters — tasks, ideas, notes, and more.',
      illustration: _IllustrationWelcome(),
    ),
    _TutorialPage(
      title: 'Add Anything You Want',
      description: "Press the '+' button to enter the 'add anything you want mode' — type freely and let the app figure out what it is.",
      illustration: _IllustrationAdd(),
    ),
    _TutorialPage(
      title: 'Explore Your Room',
      description: 'Swipe between tabs to visit your Calendar, Todos, Ideas, Notes, and Recap pages.',
        ...
        child: Padding(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              boxShadow: const [
                BoxShadow(color: Color(0x28000000), blurRadius: 32, offset: Offset(0, 8)),
              ],
            ),
            child: Column(
                ...
                FadeTransition(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      page.description,
                      textAlign: TextAlign.center,
                      style: AppText.body(size: 14, color: AppColors.muted, height: 1.55),
                    ),
                  ),
                ),
...
class _TutorialPage {
  ...
  const _TutorialPage({required this.title, required this.description, required this.illustration});
}
  ...
  Widget build(BuildContext context) {
    final child = Row(
      ...
      children: [
        ...
        if (iconOnRight) ...[const SizedBox(width: 5), Icon(icon, size: 15, color: filled ? Colors.white : AppColors.dark)],
      ],
    );
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            Text('myroom', style: AppText.display(size: 26, italic: true, weight: FontWeight.w400)),
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  const Spacer(),
                  Text('myroom', style: AppText.display(size: 18, italic: true, weight: FontWeight.w400)),
                  const Spacer(),
                  Container(
                    width: 32, height: 32,
                    decoration: BoxDecoration(
                    ...
                    child: Icon(LucideIcons.search, size: 14, color: AppColors.muted),
                  ),
                ],
              ),
            ),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    "Tap here!",
                    style: AppText.body(size: 12, color: Colors.white, weight: FontWeight.w600),
                  ),
                ),
              ],
            ),
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(label, style: AppText.caption(size: 9, color: active ? Colors.white : Colors.white38)),
                    ],
                  ),
                );
              }),
